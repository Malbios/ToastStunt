...
static const CPRange kXidStartRanges[] = {
...
static const size_t kXidStartRanges_count = sizeof(kXidStartRanges) / sizeof(kXidStartRanges[0]);

static const CPRange kXidContinueRanges[] = {
...
static const size_t kXidContinueRanges_count = sizeof(kXidContinueRanges) / sizeof(kXidContinueRanges[0]);

static const CPPair kCaseFold[] = {
...
static const size_t kCaseFold_count = sizeof(kCaseFold) / sizeof(kCaseFold[0]);

static const CPPair kSimpleUpper[] = {
    ...
    {0x1FB0, 0x1FB8}, {0x1FB1, 0x1FB9}, {0x1FB3, 0x1FBC}, {0x1FBE, 0x0399},
    ...
    {0x2C65, 0x023A}, {0x2C66, 0x023E}, {0x2C68, 0x2C67}, {0x2C6A, 0x2C69},
...
static const size_t kSimpleUpper_count = sizeof(kSimpleUpper) / sizeof(kSimpleUpper[0]);

static const CPPair kSimpleLower[] = {
    {0x0041, 0x0061}, {0x0042, 0x0062}, {0x0043, 0x0063}, {0x0044, 0x0064},
    {0x0045, 0x0065}, {0x0046, 0x0066}, {0x0047, 0x0067}, {0x0048, 0x0068},
    {0x0049, 0x0069}, {0x004A, 0x006A}, {0x004B, 0x006B}, {0x004C, 0x006C},
    {0x004D, 0x006D}, {0x004E, 0x006E}, {0x004F, 0x006F}, {0x0050, 0x0070},
    ...
    {0x1E94, 0x1E95}, {0x1E9E, 0x00DF}, {0x1EA0, 0x1EA1}, {0x1EA2, 0x1EA3},
    {0x1EA4, 0x1EA5}, {0x1EA6, 0x1EA7}, {0x1EA8, 0x1EA9}, {0x1EAA, 0x1EAB},
    {0x1EAC, 0x1EAD}, {0x1EAE, 0x1EAF}, {0x1EB0, 0x1EB1}, {0x1EB2, 0x1EB3},
    {0x1EB4, 0x1EB5}, {0x1EB6, 0x1EB7}, {0x1EB8, 0x1EB9}, {0x1EBA, 0x1EBB},
    {0x1EBC, 0x1EBD}, {0x1EBE, 0x1EBF}, {0x1EC0, 0x1EC1}, {0x1EC2, 0x1EC3},
    ...
    {0xA7CB, 0x0264}, {0xA7CC, 0xA7CD}, {0xA7CE, 0xA7CF}, {0xA7D0, 0xA7D1},
...
static const size_t kSimpleLower_count = sizeof(kSimpleLower) / sizeof(kSimpleLower[0]);
